...
Yao's \acrshort{gc} protocol presented in this thesis is secure against an \acrfull{hbc} adversary, also known as a semi-honest or passive adversary (see \sect{ssec:prelim-gc}).
...
Since in this thesis, we use the \acrshort{gc} protocol as a black-box, one can easily apply the cut-and-chose strategy to secure our frameworks against malicious adversaries.
