...
Also the protocol described in \cite{demmler2014ad}, which uses a smart-card installed in the mobile device, can benefit from our more compact circuit representation.
