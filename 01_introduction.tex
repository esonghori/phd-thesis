...
\section{Global Flow}
TinyGarble consists of:
1- GC synthesizer
2- GC engine which is based on JustGarble but also supports sequential circuits and also supports communication between two-parties and Half-Gate optimization which were both lacking in JustGarble.
