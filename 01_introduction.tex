...
For example, Demmler et al., show how our \acrshort{gc} synthesis approach can adopt and apply for the \acrshort{gmw} protocol where the cost depends on both the depth and size of the circuit~\cite{demmler2015automated}.
...
\fig{fig:tinygarbel-global-flow} illustrates the global flow of \gls{tinygarble} framework.
