...
\subsection{Oblivious Transfer}\label{sect:prelim-OT}
...
\subsection{Yao's Garbled Circuit Protocol}\label{sect:prelim_gc}
...
\subsection{Recent Improvements on the GC Protocol}
...
\subsubsection{Garbling With a Fixed-key Block Cipher}
...
\subsubsection{Half Gate}
The Half Gate method utilizes both free-XOR and row reduction and reduces the cost of AND gates by an additional $25\%$~\cite{zahur2015two}.
