...
This model can be generalized to more advanced adversary models that are typically addressed by cut-and-chose methods through multiple runs of the basic \acrshort{hbc} model~\cite{lindell2007efficient, lindell2012secure}.
