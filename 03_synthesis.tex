...
Then, we discuss the limitation of HDL synthesis techniques and tools for generating large combinational circuits.
...
\section{Technology library}\label{sect:syn-tech}
