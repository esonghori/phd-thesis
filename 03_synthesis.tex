...
Many algorithm has a loop.
\cite{} also uses rolling this loop online to make GC scalable for large function.
we will show how can we exploit loop with sequential circuit while the circuit generation remain offline.
