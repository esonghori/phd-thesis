...
In TinyGarble framework, the user may describe a function in a standard \acrshort{hdl} like Verilog or \acrshort{vhdl}.
...
\begin{enumerate}
\item The input to TinyGarble \acrshort{gc} synthesis is a file that describes a function written in an \acrshort{hdl} like Verilog or \acrshort{vhdl}.
