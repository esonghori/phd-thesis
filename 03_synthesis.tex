...
As explained in \sect{ssec:prelim-gc}, Yao's GC protocol requires the underlying function to be represented as a Boolean circuit.
...
\fig{fig:globalflow_sample} shows examples of files at different steps of TinyGarble GC synthesis flow for Hamming distance function.
