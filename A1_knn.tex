...
The circuit size and timing evaluation for 1-NN search is reported in Table \ref{tab:1_nns} for different values of $w$ and $n$.
...
The circuit size and timing evaluation for $k$-NN search is reported in Table \ref{tab:k_nns}.
